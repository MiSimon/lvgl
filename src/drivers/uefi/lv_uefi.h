...
#include <efi.h>
    ...
    #define LV_STATIC_ASSERT _Static_assert
        ...
        #error Architecture is not supported
    #endif
    #define LV_STATIC_ASSERT static_assert
#else
 ...
 * VERIFICATION
*************************************/
LV_STATIC_ASSERT(sizeof(BOOLEAN)  == 1, "Size check for 'BOOLEAN' failed.");
LV_STATIC_ASSERT(sizeof(INT8)     == 1, "Size check for 'INT8' failed.");
LV_STATIC_ASSERT(sizeof(UINT8)    == 1, "Size check for 'UINT8' failed.");
LV_STATIC_ASSERT(sizeof(INT16)    == 2, "Size check for 'INT16' failed.");
LV_STATIC_ASSERT(sizeof(UINT16)   == 2, "Size check for 'UINT16' failed.");
LV_STATIC_ASSERT(sizeof(INT32)    == 4, "Size check for 'INT32' failed.");
LV_STATIC_ASSERT(sizeof(UINT32)   == 4, "Size check for 'UINT32' failed.");
LV_STATIC_ASSERT(sizeof(INT64)    == 8, "Size check for 'INT64' failed.");
LV_STATIC_ASSERT(sizeof(UINT64)   == 8, "Size check for 'UINT64' failed.");
